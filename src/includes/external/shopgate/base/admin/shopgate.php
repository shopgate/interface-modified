...
if (isset($_GET['action']) && ($_GET["action"] === "save")) {
    ...
    try {
        ...
        if ($sg_language !== null) {
            $sgUseGlobalConfig = $shopgateConfig->checkUseGlobalFor(
                $sg_language
            );
        }
...
$catIdQuery  = "SELECT MAX(c.categories_id) as maxid FROM " . TABLE_CATEGORIES
    . " AS c ";
...
if ($_GET["sg_option"] === "config") {
    ...
    $sgInstalledShippingModules
                              = array('' => SHOPGATE_CONFIG_EXTENDED_SHIPPING_NO_SELECTION);
    ...
    foreach ($installedShippingModules as $shippingModule) {
        if (isset($shippingModule)
            ...
            require(DIR_FS_LANGUAGES . $languageDirectory . '/modules/shipping/'
                . $shippingModule);

            $shippingModule                              = substr(
                $shippingModule, 0, strrpos($shippingModule, '.')
            );
            $sgInstalledShippingModules[$shippingModule] = constant(
                'MODULE_SHIPPING_' . strtoupper($shippingModule) . '_TEXT_TITLE'
            );
        }
    }
}
...
if (defined('PROJECT_MAJOR_VERSION')) {
    require(DIR_FS_CATALOG
        . 'includes/external/shopgate/base/admin/templates/shopgate_header_v2.php');
} else {
    require(DIR_FS_CATALOG
        . 'includes/external/shopgate/base/admin/templates/shopgate_header_v1.php');
}
?>
...
<?php elseif ($_GET["sg_option"] === "help"): ?>
    <div id="shopgate_image_wiki">
        <a target="_blank" href="<?php echo SHOPGATE_LINK_WIKI; ?>">
            <img src="../includes/external/shopgate/base/admin/includes/img/shopgate_manual_logo.jpg"
                 alt="Shopgate Wiki"/>
        </a>
    </div>
<?php elseif ($_GET["sg_option"] === "config"): ?>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        ...
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_CUSTOMER_NUMBER; ?></b>
                        </td>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_SHOP_NUMBER; ?></b>
                        </td>
            ...
            <tr>
                <td class="shopgate_setting" align="right">
                    <table width="100%" cellspacing="0" cellpadding="4"
                           border="0" class="shopgate_setting">
                        <tr valign="top"
                            class="<?php echo ($alt == 'shopgate_uneven') ?
                                $alt = 'shopgate_even'
                                : $alt = 'shopgate_uneven' ?>">
                            <td width="300" class="<?php echo $tableClass; ?>">
                                <b><?php echo SHOPGATE_CONFIG_REDIRECT_LANGUAGES; ?></b>
                            </td>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="4"
                        ...
                        <tr valign="top"
                            class="<?php echo ($alt == 'shopgate_uneven') ?
                                ...
                                : $alt = 'shopgate_uneven' ?>">
                            <td width="300" class="<?php echo $tableClass; ?>">
                                <b><?php echo SHOPGATE_CONFIG_LANGUAGE; ?></b>
                            </td>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_CURRENCY; ?></b>
                        </td>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_COUNTRY; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <select name="_shopgate_config[country]">
                                    ...
                                    <?php foreach ($sgCountries as $sgCountry):
                                        ?>
                                        <option value="<?php echo $sgCountry["countries_iso_code_2"] ?>" <?php echo $shopgateConfig["country"]
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_TAX_ZONE; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <select name="_shopgate_config[tax_zone_id]">
                                    ...
                                    <?php foreach ($sgTaxZones as $sgTaxZone):
                                        ?>
                                        <option value="<?php echo $sgTaxZone["geo_zone_id"] ?>" <?php echo $shopgateConfig["tax_zone_id"]
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_REVERSE_CATEGORIES_SORT_ORDER; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <input type="radio" <?php echo $shopgateConfig["reverse_categories_sort_order"]
                                    ? 'checked=""' : '' ?> value="1"
                                       name="_shopgate_config[reverse_categories_sort_order]">
                                <?php echo SHOPGATE_CONFIG_EXTENDED_REVERSE_CATEGORIES_SORT_ORDER_ON; ?>
                                <br/>
                                <input type="radio" <?php echo !$shopgateConfig["reverse_categories_sort_order"]
                                    ? 'checked=""' : '' ?> value="0"
                                       name="_shopgate_config[reverse_categories_sort_order]">
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_REVERSE_ITEMS_SORT_ORDER; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <input type="radio" <?php echo $shopgateConfig["reverse_items_sort_order"]
                                    ? 'checked=""' : '' ?> value="1"
                                       name="_shopgate_config[reverse_items_sort_order]">
                                <?php echo SHOPGATE_CONFIG_EXTENDED_REVERSE_ITEMS_SORT_ORDER_ON; ?>
                                <br/>
                                <input type="radio" <?php echo !$shopgateConfig["reverse_items_sort_order"]
                                    ? 'checked=""' : '' ?> value="0"
                                       name="_shopgate_config[reverse_items_sort_order]">
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_PRODUCTSDESCRIPTION; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <select name="_shopgate_config[export_description_type]">
                                    <?php foreach (
                                        $sgExportDescriptionTypes as
                                        $sgDescriptionType =>
                                        $sgDescriptionTypeName
                                    ): ?>
                                        <option value="<?php echo $sgDescriptionType; ?>"
                                            <?php echo $shopgateConfig["export_description_type"]
                                            == $sgDescriptionType
                                                ? 'selected=""' : '' ?>>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXPORT_NEW_PRODUCTS_CATEGORY; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <input type="radio" <?php echo $shopgateConfig["export_new_products_category"]
                                    ? 'checked=""' : '' ?> value="1"
                                       name="_shopgate_config[export_new_products_category]">
                                <?php echo SHOPGATE_CONFIG_EXPORT_NEW_PRODUCTS_CATEGORY_ON; ?>
                                <br>
                                <input type="radio" <?php echo !$shopgateConfig["export_new_products_category"]
                                    ? 'checked=""' : '' ?> value="0"
                                       name="_shopgate_config[export_new_products_category]">
                            ...
                            <div>
                                <input type="text"
                                       value="<?php echo $shopgateConfig["export_new_products_category_id"] ?>"
                                       name="_shopgate_config[export_new_products_category_id]">
                                <?php echo SHOPGATE_CONFIG_EXPORT_NEW_PRODUCTS_CATEGORY_MAX_ID
                                    . ":" . $maxCatId ?>
                            </div>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXPORT_OPTIONS_AS_INPUT_FIELD; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <textarea type="text"
                                          name="_shopgate_config[export_option_as_input_field]"><?php echo $shopgateConfig["export_option_as_input_field"] ?></textarea>
                            </div>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXPORT_SPECIAL_PRODUCTS_CATEGORY; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <input type="radio" <?php echo $shopgateConfig["export_special_products_category"]
                                    ? 'checked=""' : '' ?> value="1"
                                       name="_shopgate_config[export_special_products_category]">
                                <?php echo SHOPGATE_CONFIG_EXPORT_SPECIAL_PRODUCTS_CATEGORY_ON; ?>
                                <br>
                                <input type="radio" <?php echo !$shopgateConfig["export_special_products_category"]
                                    ? 'checked=""' : '' ?> value="0"
                                       name="_shopgate_config[export_special_products_category]">
                            ...
                            <div>
                                <input type="text"
                                       value="<?php echo $shopgateConfig["export_special_products_category_id"] ?>"
                                       name="_shopgate_config[export_special_products_category_id]">
                                <?php echo SHOPGATE_CONFIG_EXPORT_SPECIAL_PRODUCTS_CATEGORY_MAX_ID
                                    . ":" . $maxCatId ?>
                            </div>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_SHIPPING; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <select name="_shopgate_config[shipping]">
                                    <?php foreach (
                                        $sgInstalledShippingModules as
                                        $sgShippingModuleId =>
                                        $sgShippingModuleName
                                    ): ?>
                                        <option value="<?php echo $sgShippingModuleId ?>"
                                            <?php echo $shopgateConfig["shipping"]
                                            == $sgShippingModuleId
                                                ? 'selected=""' : '' ?>>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_SHIPPING_APPROVED; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_SHIPPING_BLOCKED; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_SENT; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_CANCELED; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_SEND_ORDER_EMAIL; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input<?php echo empty($error['redirect_languages'])
                            ? '' : ' error' ?>">
                            <div>
                                <input type="radio" <?php echo $shopgateConfig["send_order_confirmation_mail"]
                                    ? 'checked=""' : '' ?> value="1"
                                       name="_shopgate_config[send_order_confirmation_mail]">
                                <?php echo SHOPGATE_CONFIG_SEND_ORDER_EMAIL_ON; ?>
                                <br>
                                <input type="radio" <?php echo !$shopgateConfig["send_order_confirmation_mail"]
                                    ? 'checked=""' : '' ?> value="0"
                                       name="_shopgate_config[send_order_confirmation_mail]">
                                <?php echo SHOPGATE_CONFIG_SEND_ORDER_EMAIL_OFF; ?>
                                <br>
                            </div>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_PAYMENT_NAME_MAPPING; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                                <textarea type="text"
                                          name="_shopgate_config[payment_name_mapping]"><?php echo $shopgateConfig["payment_name_mapping"] ?></textarea>
                            </div>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_EXTENDED_ENCODING; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input">
                            <div>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="0"
                    ...
                    <tr valign="top"
                        class="<?php echo ($alt == 'shopgate_uneven') ?
                            ...
                            : $alt = 'shopgate_uneven' ?>">
                        <td width="300" class="<?php echo $tableClass; ?>">
                            <b><?php echo SHOPGATE_CONFIG_SERVER_TYPE; ?></b>
                        </td>
                        <td class="<?php echo $tableClass; ?> shopgate_input<?php echo empty($error['api_url'])
                            ? '' : ' error' ?>">
                            <div>
                                <select name="_shopgate_config[server]">
                                    <option value="live" <?php echo $shopgateConfig["server"]
                                    == 'live' ? 'selected=""' : '' ?>>
                                        <?php echo SHOPGATE_CONFIG_SERVER_TYPE; ?>
                                    </option>
                                    <option value="pg" <?php echo $shopgateConfig["server"]
                                    == 'pg' ? 'selected=""' : '' ?>>
                                        <?php echo SHOPGATE_CONFIG_SERVER_TYPE_PG; ?>
                                    </option>
                                    <option value="custom" <?php echo $shopgateConfig["server"]
                                    == 'custom' ? 'selected=""' : '' ?>>
    ...
    <div class="sg_submit"><input type="submit"
                                  ...
                                  onclick="this.blur();" class="button"></div>
    </form>
<?php endif; ?>
</td>
</tr>
