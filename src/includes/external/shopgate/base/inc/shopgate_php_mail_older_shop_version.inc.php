...
function shopgate_php_mail(
    $from_email_address, $from_email_name,
    $to_email_address, $to_name, $forwarding_to, $reply_address,
    $reply_address_name, $path_to_attachement, $path_to_more_attachements,
    ...
    if (file_exists(
        ...
        $html_signatur = $mailsmarty->fetch(
            DIR_FS_CATALOG . 'templates/' . CURRENT_TEMPLATE . '/mail/'
            . $_SESSION['language'] . '/signatur.html'
        );
    }
    ...
    if (file_exists(
        ...
        $html_widerruf = $mailsmarty->fetch(
            DIR_FS_CATALOG . 'templates/' . CURRENT_TEMPLATE . '/mail/'
            . $_SESSION['language'] . '/widerruf.html'
        );
    }
    ...
    */
    ...
    if (EMAIL_TRANSPORT == 'smtp') {
        ...
        $mail->SMTPAuth
                             = SMTP_AUTH; // turn on SMTP authentication true/false
    ...
    if (EMAIL_USE_HTML == 'true') { // set email format to HTML
        ...
        // remove html tags
        $message_body_plain = str_replace(
            '<br />', " \n", $message_body_plain . $txt_signatur
