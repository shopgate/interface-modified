...
class ShopgateInstallHelper
{
    ...
    private function getUid()
    {
        ...
        $keyQuery
                = 'SELECT c.configuration_value AS val FROM '
            . TABLE_CONFIGURATION
     ...
     *
     * @param bool $ignoreDeactivated if true the deactivated categories will
     *                                be ignored
     *
     * @return int
     */
    ...
    {
        $query
                = 'SELECT configuration_value AS currency FROM '
            . TABLE_CONFIGURATION
            . ' AS c
				   where c.configuration_key = "'
