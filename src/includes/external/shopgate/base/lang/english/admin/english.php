...
define(
    ...
    'Choose the encoding of your shop system. This is usually "ISO-8859-15" for versions before 1.06.'
);
...
define(
    'SHOPGATE_LINK_WIKI',
    'https://support.shopgate.com/hc/en-us/articles/202911763'
);
...
define(
    ...
    'Please check your input in the following fields: '
);
define(
...
define(
    ...
    'Configurations for multiple market places are active.'
);
...
define(
    ...
    'Use the global configuration for this language.'
);
define(
    'SHOPGATE_CONFIG_MULTIPLE_SHOPS_BUTTON',
    'Setup multiple Shopgate marketplaces'
);
define(
...
define(
    'SHOPGATE_CONFIG_CNAME',
    'Custom URL to mobile webpage (CNAME) incl. http://'
);
define(
...
define(
    'SHOPGATE_CONFIG_EXTENDED_PRODUCTSDESCRIPTION_DESC_ONLY', 'Description only'
);
define(
...
define(
    'SHOPGATE_CONFIG_EXTENDED_CUSTOMER_PRICE_GROUP', 'Price group for Shopgate'
);
define(
    'SHOPGATE_CONFIG_EXTENDED_CUSTOMER_PRICE_GROUP_DESCRIPTION',
    'Choose the valid price group for Shopgate (the customer group of which the price information is taken for the products export).'
);
define(
    'SHOPGATE_CONFIG_EXTENDED_CUSTOMER_PRICE_GROUP_OFF', '-- Deactivated --'
);

define(
    'SHOPGATE_CONFIG_EXPORT_NEW_PRODUCTS_CATEGORY', 'Export the "New" category'
);
define(
    'SHOPGATE_CONFIG_EXPORT_NEW_PRODUCTS_CATEGORY_DESCRIPTION',
    'This shopsystem allows you to show all new products in an virtual category. With this option it is possible to export the new products in an real category. Therefore you can use the input field to change the category id.'
);
...
define(
    ...
    'Currently highest categorie-Id in the shopsystem'
);

define(
    'SHOPGATE_CONFIG_EXPORT_OPTIONS_AS_INPUT_FIELD',
    'Product options to be exported as input fields'
);
define(
    'SHOPGATE_CONFIG_EXPORT_OPTIONS_AS_INPUT_FIELD_DESCRIPTION',
    'Add the option IDs (see "Product Options") that should be exported as input fields. Example: 1,2,3'
);

define(
    'SHOPGATE_CONFIG_EXPORT_SPECIAL_PRODUCTS_CATEGORY',
    'Export the "Special" category'
);
define(
    'SHOPGATE_CONFIG_EXPORT_SPECIAL_PRODUCTS_CATEGORY_DESCRIPTION',
    'This shopsystem allows you to show all special products in an virtual category. With this option it is possible to export the new products in an real category. Therefore you can use the input field to change the category id.'
);
...
define(
    ...
    'Choose the Shopgate customer group (the customer group that all guest customers will be set to on importing orders).'
);
...
define(
    'SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_SHIPPING_BLOCKED', 'Shipping blocked'
);
define(
...
define(
    ...
    'After an shopgate order has been successfully completed, an confirmation mail will be send to the customer.if the product(s) were downloadble the download link is included in this mail.'
);

define(
    'SHOPGATE_CONFIG_PAYMENT_NAME_MAPPING', 'Display names for payment methods'
);
define(
...
define(
    ...
    'https://support.shopgate.com/hc/en-us/articles/202911763-Connecting-to-modified-eCommerce#4.4'
);
define(
...
define(
    ...
    'Choose the Shopgate server to connect to.'
);
