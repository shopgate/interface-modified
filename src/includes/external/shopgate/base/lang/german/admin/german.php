...
define(
    'SHOPGATE_LINK_WIKI',
    'https://support.shopgate.com/hc/de/articles/202911763'
);
...
define(
    'SHOPGATE_CONFIG_ERROR_SAVING', 'Fehler beim Speichern der Konfiguration. '
);
define(
    'SHOPGATE_CONFIG_ERROR_LOADING', 'Fehler beim Laden der Konfiguration. '
);
define(
    'SHOPGATE_CONFIG_ERROR_READ_WRITE',
    'Bitte &uuml;berpr&uuml;fen Sie die Schreibrechte (777) f&uuml;r den Ordner "/shopgate_library/config/" des Shopgate-Plugins.'
);
define(
    'SHOPGATE_CONFIG_ERROR_INVALID_VALUE',
    'Bitte &uuml;berpr&uuml;fen Sie Ihre Eingaben in den folgenden Feldern: '
);
define(
    'SHOPGATE_CONFIG_ERROR_DUPLICATE_SHOP_NUMBERS',
    'Es existieren mehrere Konfigurationen mit der gleichen Shop-Nummer. Dies kann zu erheblichen Problemen f&uuml;hren!'
);
define(
...
define(
    'SHOPGATE_CONFIG_USE_GLOBAL_CONFIG',
    'F&uuml;r diese Sprache die globale Konfiguration nutzen.'
);
define(
    'SHOPGATE_CONFIG_MULTIPLE_SHOPS_BUTTON',
    'Mehrere Shopgate-Marktpl&auml;tze einrichten'
);
define(
...
define(
    ...
    'Tragen Sie hier den API-Key Ihres Shops ein. Sie finden diesen im Tab &quot;Integration&quot; Ihres Shops.'
);
...
define(
    ...
    'Tragen Sie hier den Alias Ihres Shops ein. Sie finden diesen im Tab &quot;Integration&quot; Ihres Shops.'
);

define(
    'SHOPGATE_CONFIG_CNAME', 'Eigene URL zur mobilen Webseite (mit http://)'
);
define(
...
define(
    'SHOPGATE_CONFIG_EXTENDED_CURRENCY_DESCRIPTION',
    'W&auml;hlen Sie die W&auml;hrung f&uuml;r den Produktexport.'
);
...
define(
    'SHOPGATE_CONFIG_EXTENDED_REVERSE_CATEGORIES_SORT_ORDER',
    'Kategorie-Reihenfolge umkehren'
);
...
define(
    'SHOPGATE_CONFIG_EXTENDED_REVERSE_ITEMS_SORT_ORDER',
...
define(
    'SHOPGATE_CONFIG_EXTENDED_PRODUCTSDESCRIPTION_DESC_ONLY', 'Nur Beschreibung'
);
define(
    'SHOPGATE_CONFIG_EXTENDED_PRODUCTSDESCRIPTION_SHORTDESC_ONLY',
    'Nur Kurzbeschreibung'
);
define(
    'SHOPGATE_CONFIG_EXTENDED_PRODUCTSDESCRIPTION_DESC_SHORTDESC',
    'Beschreibung + Kurzbeschreibung'
);
define(
    'SHOPGATE_CONFIG_EXTENDED_PRODUCTSDESCRIPTION_SHORTDESC_DESC',
...
define(
    'SHOPGATE_CONFIG_EXTENDED_CUSTOMER_PRICE_GROUP',
    'Preisgruppe f&uuml;r Shopgate'
);
define(
    'SHOPGATE_CONFIG_EXTENDED_CUSTOMER_PRICE_GROUP_DESCRIPTION',
    'W&auml;hlen Sie die Preisgruppe, die f&uuml;r Shopgate gilt (bzw. die Kundengruppe, aus welcher die Preisinformationen beim Produktexport verwendet werden).'
);
define(
    'SHOPGATE_CONFIG_EXTENDED_CUSTOMER_PRICE_GROUP_OFF', '-- Deaktiviert --'
);

define(
    'SHOPGATE_CONFIG_EXPORT_NEW_PRODUCTS_CATEGORY', 'Export der "Neu" Kategorie'
);
define(
    'SHOPGATE_CONFIG_EXPORT_NEW_PRODUCTS_CATEGORY_DESCRIPTION',
    'Dieses Shopsystem bietet die M&ouml;glichkeit eine virtuelle Kategorie f&uuml;r neue Produkte anzulegen. Diese kann mit Hilfe dieser Option als Kategorie exportiert werden. Weiterhin ist es m&ouml;glich, im Eingabefeld eine einzigartige ID f&uuml;r diese Kategorie festzulegen.'
);
define('SHOPGATE_CONFIG_EXPORT_NEW_PRODUCTS_CATEGORY_ON', 'Ja');
define('SHOPGATE_CONFIG_EXPORT_NEW_PRODUCTS_CATEGORY_OFF', 'Nein');
define(
    'SHOPGATE_CONFIG_EXPORT_NEW_PRODUCTS_CATEGORY_MAX_ID',
    'Aktuell h&ouml;chste Kategorie ID Ihres Shopsystems'
);

define(
    'SHOPGATE_CONFIG_EXPORT_SPECIAL_PRODUCTS_CATEGORY',
    'Export der "Spezial" Kategorie'
);
define(
    'SHOPGATE_CONFIG_EXPORT_SPECIAL_PRODUCTS_CATEGORY_DESCRIPTION',
    'Dieses Shopsystem bietet die M&ouml;glichekeit eine virtuelle Kategorie f&uuml;r Spezial-Produkte anzulegen. Diese kann mit Hilfe dieser Option als Kategorie exportiert werden. Weiterhin ist es m&ouml;glich, im Eingabefeld, eine einzigartige ID f&uuml;r diese Kategorie festzulegen.'
);
...
define(
    'SHOPGATE_CONFIG_EXPORT_SPECIAL_PRODUCTS_CATEGORY_MAX_ID',
    'Aktuell h&ouml;chste Kategorie ID Ihres Shopsystems'
);

define(
    'SHOPGATE_CONFIG_EXPORT_OPTIONS_AS_INPUT_FIELD',
    'Export von Produkoptionen als Eingabefelder'
);
define(
    'SHOPGATE_CONFIG_EXPORT_OPTIONS_AS_INPUT_FIELD_DESCRIPTION',
    'Die IDs der Produktoptionen (siehe "Artikelmerkmale"), die als Eingabefelder exportiert werden m&uuml;ssen. Beispiel: 1,2,3'
);

define(
    'SHOPGATE_PLUGIN_FIELD_AVAILABLE_TEXT_AVAILABLE_ON_DATE',
    'Verf&uuml;gbar ab dem #DATE#'
);

### Bestellungsimport ###
define('SHOPGATE_CONFIG_ORDER_IMPORT_SETTINGS', 'Bestellungsimport');
define(
    'SHOPGATE_ORDER_CUSTOM_FIELD',
    'Benutzerdefinierte Eingabefelder zu einer Shopgate Bestellung:'
);

define('SHOPGATE_CONFIG_EXTENDED_CUSTOMER_GROUP', 'Kundengruppe');
define(
    'SHOPGATE_CONFIG_EXTENDED_CUSTOMER_GROUP_DESCRIPTION',
    'W&auml;hlen Sie die Gruppe f&uuml;r Shopgate-Kunden (die Kundengruppe, unter welcher alle Gastkunden von Shopgate beim Bestellungsimport eingerichtet werden).'
);
...
define(
    'SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_SHIPPING_APPROVED',
...
define(
    'SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_SHIPPING_BLOCKED',
    'Versand blockiert'
);
define(
...
define(
    'SHOPGATE_CONFIG_EXTENDED_STATUS_ORDER_CANCELED_NOT_SET',
    '- Status nicht ausgew&auml;hlt -'
);
define(
...
define(
    'SHOPGATE_CONFIG_SEND_ORDER_EMAIL_DESCRIPTION',
    'Nachdem eine Bestellung &uuml;ber Shopgate abgeschlossen wurde, bekommt der Kunde eine Bestellbest&auml;tigungs-Email. Sollte der Shop Produkte zum Kauf anbieten, welche heruntergeladen werden k&ouml;nnen, enth&auml;lt diese Mail den Downloadlink.'
);

define(
    'SHOPGATE_CONFIG_PAYMENT_NAME_MAPPING',
    'Anzeigenamen f&uuml;r Zahlungsweisen'
);
define(
...
define(
    ...
    'https://support.shopgate.com/hc/de/articles/202911763-Anbindung-an-modified-eCommerce#4.4'
);
define(
    'SHOPGATE_CONFIG_PAYMENT_NAME_MAPPING_LINK_DESCRIPTION',
    "Link zur Anleitung"
);
...
define(
    'SHOPGATE_CONFIG_SERVER_TYPE_CUSTOM_URL',
    'Benutzerdefinierte URL zum Shopgate-Server'
);
define(
    'SHOPGATE_CONFIG_SERVER_TYPE_DESCRIPTION',
    'W&auml;hlen Sie hier die Server-Verbindung zu Shopgate aus.'
);
